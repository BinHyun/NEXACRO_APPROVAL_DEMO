...
public class TEST_02BaseAutomationLogic extends BaseAutomationLogic {
	...
	public void modify(ParameterSet globalParameterSet) throws AutomationFailException {//!findOffset_modify!
		...
		tmpParameterSet.add(globalParameterSet.getParameter("dsSaveList"));
		...
		info.setSqlInsert("INSERT INTO EMPLOYEE(\n EMP_ID\n , NAME\n , GENDER\n , DEPARTMENT\n , SALARY\n , YEARS_WORKED\n )\n VALUES (\n #dsSaveList.EMP_ID#\n , #dsSaveList.NAME#\n , #dsSaveList.GENDER#\n , #dsSaveList.DEPARTMENT#\n , #dsSaveList.SALARY#\n , #dsSaveList.YEARS_WORKED#\n )\n ");
		info.setSqlUpdate("");
		info.setSqlDelete("");
		info.setResultNameSet(resultNameSet);
		info.setParameterSet(tmpParameterSet);
		info.setLoopTargetDataSetName("dsSaveList");
