...
public class _XUP_TEST_02BaseAutomationLogic extends BaseAutomationLogic {
	...
	private void initParameterSet(ParameterSet globalParameterSet) {
		...
		dataset1.addColumn("EV_TITLE", PlatformDataType.STRING, 255);
		dataset1.addColumn("EV_DESC", PlatformDataType.STRING, 255);
		dataset1.addColumn("REG_EMP_NO", PlatformDataType.STRING, 255);
		dataset1.addColumn("REG_USER_NM", PlatformDataType.STRING, 255);
		dataset1.addColumn("REG_DT", PlatformDataType.STRING, 255);
		dataset1.addColumn("LAST_UPDATED_AT", PlatformDataType.STRING, 255);
		...
		dataset1.addColumn("STATUS_CD", PlatformDataType.STRING, 255);
		dataset1.addColumn("DELETED_YN", PlatformDataType.STRING, 255);
